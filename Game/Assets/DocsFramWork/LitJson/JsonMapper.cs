    ...
    public class JsonMapper
    {
		...
		private static object ReadValue (Type inst_type, JsonReader reader, object instance = null)
        {
            ...
            if (reader.Token == JsonToken.ArrayStart) {
				...
				if( instance == null) //Miru - Add This Line
		...
		// Miru - Custom
		public static object ToObject (object instance, string json)
		{
			JsonReader reader = new JsonReader (json);
			return ReadValue ( instance.GetType (), reader, instance);
		}		
		// Miru end
